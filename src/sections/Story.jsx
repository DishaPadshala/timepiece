import storyWatch from '../assets/img/story.png';
    ...
    <section className="story section container">
      <div className="story__container grid">
        <div className="story__data">
          ...
          <h1 className="story__title">Inspirational Watch of <br /> this year</h1>
        ...
        <div className="story__images">
          <img src={storyWatch} alt="Inspirational watch" className="story__img" />
